<?php
    ...
    {
        //$url = "http://novaposhta.ua/frontend/tracking/ru?en=".$dec_num;
        $url= "http://novaposhta.ua/tracking/?cargo_number=".$dec_num."&language=ru";
    ...
    $cargo_arrive_backshipment_template =
        ...
        '<p><strong>Информация про оплату:</strong>.*Сумма .* - (?<cash_amount>.*?)</p>~';
