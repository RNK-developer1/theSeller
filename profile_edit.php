<?php 
	...
	$query = "UPDATE users SET alphaname = :alphaname, phone = :phone, username = :username, newpost_api = :newpost_api, newpost_id = :newpost_id, newpost_psw = :newpost_psw, sender_whs_ref = :sender_whs_ref, fio_ukr = :fio_ukr, pass_s = :pass_s, pass_n = :pass_n, pass_issued = :pass_issued, pass_i_date = :pass_i_date, adr = :adr WHERE id = :id";
	$query_params = array( 
		':id' => $_SESSION['user']['id'],
		':phone' => $_POST['phone'],
		...
		':newpost_id' => $_POST['newpost_id'],
		':newpost_psw' => $_POST['newpost_psw'],
	...
	try{ 
		...
		$_SESSION['user']['newpost_id'] = $_POST['newpost_id'];
		$_SESSION['user']['newpost_psw'] = $_POST['newpost_psw'];
