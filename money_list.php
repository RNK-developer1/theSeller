...
<html lang="ru">
	...
	<?php
		...
		foreach ($orders as $ord) {
			...
			?>
				<tr>
                    <td><a target="_new" href="http://novaposhta.ua/tracking/?cargo_number=<?php echo $ord['newpost_id'] ?>&language=ru"><?php echo $ord['newpost_id'] ?></a></td>
	...
	<?php
		...
		foreach ($orders as $ord) {
			...
			?>
				<tr>
					<td><a target="_new" href="http://novaposhta.ua/tracking/?cargo_number=<?php echo $ord['newpost_backorder'] ?>&language=ru"><?php echo $ord['newpost_backorder'] ?></a></td>
