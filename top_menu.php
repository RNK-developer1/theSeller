<?php
	...
	//  =================================================================================================================
	//  Опции фильтра (начало)
	//  =================================================================================================================

	$filter_options = array(); 

	// 1. Определение опций фильтра

	// 1.1. Предприниматель 
	// (приоритет - 1. активный выбор текущего пользователля, 2. сохраненное значение в сессии, 3. текущий пользователь)
	$selected_seller = 0;
