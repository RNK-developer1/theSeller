<?php 
    ...
    error_reporting(E_ALL ^ E_NOTICE); // обнаружены нотайсы, искажающие интерфейс, отключены временно
    ...
    try { $db = new PDO("mysql:host={$host};port={$port};dbname={$dbname};charset=utf8", $username, $password, $options); } 
